...
path = "/local2/dmreynos/diffuser_bball/logs/guided_samples_0.1/2016.NBA.Raw.SportVU.Game.Logs12.05.2015.POR.at.MIN_dir-0-guided-245K.npy"  # Replace with the path to your .npy file
...
print(diffuser_output[0][0].reshape(11,6).astype(int))
print(diffuser_output[0][1].reshape(11,6).astype(int))
